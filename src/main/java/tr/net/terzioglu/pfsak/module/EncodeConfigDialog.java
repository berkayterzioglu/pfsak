...
public class EncodeConfigDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Base64", "Hex to Bin", "UU" }));
...
//            java.util.logging.Logger.getLogger(EncodeConfigDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                EncodeConfigDialog dialog = new EncodeConfigDialog(new javax.swing.JFrame(), true);
...
//    }
    ...
    void setEncodeConfig(EncodeConfig aThis) {
        ec = aThis;
        jComboBox1.setSelectedIndex(ec.getEncodeType().ordinal());
